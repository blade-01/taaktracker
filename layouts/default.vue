...
.sidebar-wrapper {
  ...
  /* MARGIN */
  md:ml-[var(--sidebar-width-md)] lg:ml-[var(--sidebar-width-lg)] 2xl:ml-[var(--sidebar-width-2xl)]
  /* WIDTH */
  md:w-[calc(100%-var(--sidebar-width-md))] lg:w-[calc(100%-var(--sidebar-width-lg))] 2xl:w-[calc(100%-var(--sidebar-width-2xl))];
}
.mainbar-opened {
